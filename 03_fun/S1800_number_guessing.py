...
blackcoin = 0
whitecoin = 0
ciffer4number = random.randint(0, 9999)
numguess = input("guess 4 cifer number: ")
if numguess == str(ciffer4number):
    print("right! 1 white coin")
    whitecoin += 1
elif numguess != str(ciffer4number):

    print("wrong guess. 1 black coin")
    blackcoin += 1
